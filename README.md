...
- The first and last segments keep the particle mass and volume constant
...
The calibration targets **municipal solid waste (MSW) particles** and is based on a **35 MWth Waste-to-Energy power plant** as reference geometry and operating conditions.
